...
#define CCPointLog(p) CCLog("%s::%d::%s: (%.1f, %.1f)", __FILE__+76, __LINE__, #p, (p).x, (p).y)
#define CCSizeLog(s) CCLog("%s::%d::%s: (%.1f, %.1f)", __FILE__+76, __LINE__, #s, (s).width, (s).height)
#define CCRectLog(r) CCLog("%s::%d::%s: (%.1f, %.1f) - (%.1f, %.1f)", __FILE__+76, __LINE__, #r, \
