...
void
MCBase64Encode(mc_byte_t *input, mc_size_t in_len, mc_byte_t **output)
{
    *output = (mc_byte_t *) base64_encode((const unsigned char *) input, (int) in_len);
}

mc_size_t
MCBase64Decode(mc_byte_t *input, mc_size_t in_len, mc_byte_t **output)
{
    mc_size_t size;
    *output = (mc_byte_t *) base64_decode((const char *) input, (int) in_len, (int *) &size);
    return size;
}
