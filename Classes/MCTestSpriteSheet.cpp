...
bool
MCTestSpriteSheet::init()
{
    if (MCTestLayer::initWithColor(ccc4(255, 255, 255, 255)))
    {
...
void MCTestSpriteSheet::registerWithTouchDispatcher()
{
    CCDirector::sharedDirector()->getTouchDispatcher()->addTargetedDelegate(this, 0, true);
}

bool MCTestSpriteSheet::ccTouchBegan(CCTouch *pTouch, CCEvent *pEvent)
{
...
void MCTestSpriteSheet::ccTouchMoved(CCTouch *pTouch, CCEvent *pEvent)
{
...
void MCTestSpriteSheet::ccTouchCancelled(CCTouch* touch, CCEvent* event)
{
}

void MCTestSpriteSheet::ccTouchEnded(CCTouch *pTouch, CCEvent *pEvent)
{
...
void
MCTestSpriteSheet::ccTouchesEnded(CCSet *pTouches, CCEvent *pEvent)
{
}
