...
bool
CCSpiritedJoystick::initWithResources(CCSprite *background,
                                CCSprite *control)
{
    CCSize size;
...
CCSpiritedJoystick *
CCSpiritedJoystick::joystickWithResources(CCSprite *background,
                                      CCSprite *control)
{
    CCSpiritedJoystick *joystick;

    joystick = new CCSpiritedJoystick;
...
void
CCSpiritedJoystick::moveControl(CCPoint offsetPosition)
{
    m_sControl->setPosition (offsetPosition);
}

void CCSpiritedJoystick::handleMoving(CCPoint point, CCSpiritedJoystickHandler *handler)
{
    float angle;
